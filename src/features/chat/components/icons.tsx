...
export const MicroscopeIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M3.61133 27.5H14.4447M13.241 7.81504C14.0104 7.60938 14.8171 7.5 15.6484 7.5C20.9667 7.5 25.278 11.9772 25.278 17.5C25.278 21.6967 22.7885 25.2896 19.2595 26.7731M6.62059 16.25H11.4354C11.9947 16.25 12.2744 16.25 12.5069 16.298C13.4619 16.4953 14.2084 17.2705 14.3984 18.2623C14.4447 18.5038 14.4447 18.7942 14.4447 19.375C14.4447 19.9558 14.4447 20.2462 14.3984 20.4877C14.2084 21.4795 13.4619 22.2547 12.5069 22.452C12.2744 22.5 11.9947 22.5 11.4354 22.5H6.62059C6.06128 22.5 5.78163 22.5 5.54907 22.452C4.59408 22.2547 3.84755 21.4795 3.65759 20.4877C3.61133 20.2462 3.61133 19.9558 3.61133 19.375C3.61133 18.7942 3.61133 18.5038 3.65759 18.2623C3.84755 17.2705 4.59408 16.4953 5.54907 16.298C5.78163 16.25 6.06128 16.25 6.62059 16.25ZM4.81503 6.875V16.25H13.241V6.875C13.241 4.45875 11.3548 2.5 9.028 2.5C6.70124 2.5 4.81503 4.45875 4.81503 6.875Z"
        stroke="currentColor"
        strokeWidth="2.43873"
        strokeLinecap="round"
        strokeLinejoin="round"
